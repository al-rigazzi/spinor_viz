...
\begin{enumerate}
  ...
  \item \textbf{Construct} the two plane-dihedral circles $c_\uparrow$ and $c_\downarrow$ as explicit plane--sphere intersections,
...
\paragraph{Plane-dihedral face normals and offsets.}
