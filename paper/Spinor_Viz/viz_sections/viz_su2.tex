...
The hyperchord construction of Section~\ref{sec:hyperchords} realizes, in geometric terms, the standard parametrization of a two-component spinor and the associated Bloch vector map.
...
From Section~\ref{sec:hyperchords_faces}, the two hyperchord circles have radii
\[
...
\end{equation}
Thus, at fixed \(u\), the hyperchord face areas encode the standard two-level Born weights.
...
Finally, the remaining angular degrees of freedom in \eqref{eq:spinor_symmetric_halfangle} are visible as in-face rotations of the two hyperchord faces.
