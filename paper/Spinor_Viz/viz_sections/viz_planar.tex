...
Before constructing the full three-dimensional spinor visualization, we develop a simpler two-dimensional precursor that captures the essential half-angle geometry. This planar construction isolates the dependence of spinor \emph{magnitudes} on a half-angle and motivates the spatial ``hyperchord'' construction used later.
...
\begin{itemize}
    \item chord lengths become radii of plane--sphere intersection circles (the ``hyperchord faces'');
