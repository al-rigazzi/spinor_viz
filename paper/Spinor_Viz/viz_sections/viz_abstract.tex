We introduce \emph{hyperchords}, a geometric visualization for two-dimensional spinors (qubit
states) embedded in $\mathbb{R}^3$.
Whereas the Bloch-sphere map identifies states that differ by a global $U(1)$ phase, hyperchords
...
(the \emph{hyperchord faces}): their radii encode the component moduli, while face markers encode
