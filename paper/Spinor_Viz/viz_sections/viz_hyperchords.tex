\section{\label{sec:hyperchords} Hyperchord construction in three dimensions}
...
which we call the \emph{hyperchord faces}.
...
The hyperchord planes $U'$ and $L'$ are defined as follows.
...
The two hyperchord circles are then defined as the corresponding sphere sections
\[
...
Each hyperchord circle is tangent to the reference equator $e$ at a single point, and these two tangent
...
\begin{figure}[ht!]
    ...
    \caption{Hyperchord construction. The rotated equatorial plane $E'$ (primary datum) fixes the unit normal
    $\vv$ and the dihedral angle $\theta$ with the reference plane $E=\xyplane$. The rotated equator
    $e'=E'\cap S_u$ has a distinguished highest point $Q$. The two hyperchord planes $U'$ and $L'$ are the
